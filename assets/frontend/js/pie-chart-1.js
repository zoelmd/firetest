    ...
    (function (a) {
        ...
        e(A.prototype, {
            ...
            getContrast: function (a) {
                a = l(a).rgba;
                return 510 < a[0] + a[1] + a[2] ? "#34495e" : "#FFFFFF"
            },
...
k, '" filled\x3d"false" path\x3d"', H, '" coordsize\x3d"10 10" style\x3d"', p.style.cssText, '" /\x3e'], n = F(d.prepVML(h), null, {
                    ...
                    }), e && (n.cutOff = k + 1), h = ['\x3cstroke color\x3d"', a.color || "#34495e", '" opacity\x3d"', D * q, '"/\x3e'], F(d.prepVML(h), null, null, n), b ? b.element.appendChild(n) : p.parentNode.insertBefore(n, p), c.push(n);
                    this.shadows = c
                }
                return this
            },
    ...
    (function (a) {
        ...
        d.prototype.drawDataLabels = function () {
            ...
            if (g.enabled || b._hasPointLabels) b.dlProcessOptions && b.dlProcessOptions(g), q = b.plotGroup("dataLabelsGroup", "data-labels", B && !c ? "hidden" : "visible", g.zIndex || 6), B && (q.attr({
                ...
                if (e = t(l && l.enabled, m.enabled) && null !== c.y) g = r(m, l), n = c.getLabelConfig(), u = g.format ? f(g.format, n) : g.formatter.call(n, g), B = g.style, n = g.rotation, B.color = t(g.color, B.color, b.color, "#34495e"), "contrast" === B.color && (c.contrastColor = A.getContrast(c.color || b.color), B.color = g.inside || 0 > t(c.labelDistance, g.distance) || d.stacking ? c.contrastColor : "#34495e"), d.cursor && (B.cursor = d.cursor),
                    h = {
